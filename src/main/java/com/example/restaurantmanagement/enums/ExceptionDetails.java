...
public enum ExceptionDetails {
    BANNER_NOT_FOUND, CATEGORY_NOT_FOUND, MEAL_NOT_FOUND, EMAIL_NOT_FOUND, USER_NOT_FOUND, FEEDBACK_NOT_FOUND, TABLE_NOT_FOUND, RESERVATION_NOT_FOUND, ORDER_NOT_FOUND,
    ALREADY_EXIST, THIS_EMAIL_IS_ALREADY_EXIST, TABLE_IS_ALREADY_EXIST, POSITION_IS_FULL,
    INVALID_ADDRESS;
